...
|`template-gui.cancel.enabled`|`boolean`|Whether or not to show this item in the GUI|
...
|`template-gui.uncategorized.enabled`|`boolean`|Whether or not to show this item in the GUI|
...
| Key | Type | Description |
|---|---|---|
|`templates.<category>.gui.enabled`|`boolean`|Whether or not to show this item in the GUI|
